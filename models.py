...
class Canal(db.Model):
    ...
    grupo = db.Column(db.String(100))  # group-title original
    tvg_id = db.Column(db.String(100))
    tipo = db.Column(db.String(20))  # 'tv', 'serie', 'filme', 'radio'
    serie_nome = db.Column(db.String(200))  # nome base da série
    temporada = db.Column(db.Integer)
    episodio = db.Column(db.Integer)
    categoria = db.Column(db.String(100))  # extraído do group-title
